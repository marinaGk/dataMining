...
#     return stats_of_day_demands,stats_of_day_sources
...
# stats_of_day_demands,stats_of_day_sources = creation_of_files(0,4)
...
# new_csv.to_csv( "Variance.csv", index=False, encoding='utf-8-sig')

# stats_of_day_demands,stats_of_day_sources = creation_of_files(0,1)
...
# os.chdir(mypath)
# new_csv = pd.DataFrame(X1)
# new_csv.to_csv( "Variance-0.csv", index=False, encoding='utf-8-sig')

# stats_of_day_demands,stats_of_day_sources = creation_of_files(1,2)
...
# os.chdir(mypath)
# new_csv = pd.DataFrame(X1)
# new_csv.to_csv( "Variance-1.csv", index=False, encoding='utf-8-sig')

# stats_of_day_demands,stats_of_day_sources = creation_of_files(2,3)
...
# os.chdir(mypath)
# new_csv = pd.DataFrame(X1)
# new_csv.to_csv( "Variance-2.csv", index=False, encoding='utf-8-sig')

# stats_of_day_demands,stats_of_day_sources = creation_of_files(3,4)
